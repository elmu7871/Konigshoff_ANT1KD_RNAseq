...
```{r build geneInfo and antfarmking}
...
colnames(antfarmking) <- colnames(antfarmking) %>%
  gsub(pattern = "Bleo", replacement = "bleo")

# saveRDS(antfarmking, file = "/Users/libbymurphy/Documents/GitHub/Konigshoff_ANT1KD_RNAseq/accessories/antfarmking.RDS")
# break glass in case of read_tsv() meltdown

rownames(antfarmking) <- antfarmking[,1]

mart <- useDataset("hsapiens_gene_ensembl", useMart("ensembl"))

genes <- antfarmking$gene_id
...
# ggplot2::ggsave(filename = "/Users/libbymurphy/Documents/GitHub/Konigshoff_ANT1KD_RNAseq/results/PCAplot_QC.png", plot = PCAplot, device = "png")
```

```{r build DESeq object}
